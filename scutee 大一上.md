...
---
#### 课程
C/C++是一种广泛使用的计算机程序设计语言，课程内容主要是掌握语法知识及其计算机应用，目前最值得掌握的两门语言是C/C++和python。对于编程，如果课后不花大量时间拓展学习，就不能算掌握。为真正理解C++，入门书籍推荐《C++ Primer plus》，进阶书籍推荐《Effective C++》，更多书籍详见文章 [C++必读书籍推荐](http://bestcbooks.com/recommended-cpp-books/)。当然，实战也不能落后，推荐编译器Dev C++以及前往 [PAT乙级](https://www.patest.cn/contests/pat-b-practise) 刷题（高手请直接前往天梯或者ACM），更粗暴有效的做法是安装Ubuntu双系统练习编程。编程是一条很长的路，需要踏踏实实往前走，坚持下来就会发现收获很多。

【补充】有部分学生，由于之前没有接触过这个领域，觉得编程陌生和晦涩，可以在暑假期间预习C++或者熟悉Python，掌握了基础语法和思想之后，学习会变得顺畅，认真听课认真做题积极实践就好~
...
为方便资料上传、下载和管理，在下即将采用ftp服务器，向大家提供资源。华工校园网采用双栈接入，ipv4地址受学校收费管制，ipv6无状态自动获取固定公网ip，所以大家能够直接给笔记本电脑插入网线，通过ipv6线路，与服务器通信传输文件，速度能达到2M以上。服务器的权限为在下控制，分为普通用户（只能读取）和高级用户（读取和修改）。
...
高级账户不公开，起作用在于：一方面，在下想寻找几位有心的伙伴，帮忙对资料进行管理更新；另一方面，如果有朋友想要传入资源，可以向在下询问高级账户，对资源进行修改。

连接ftp服务器的步骤：连接网线=>资源管理器输入：`ftp://[2001:250:3000:4bf5:c9dc:e263:e9f0:8567]/`=>登录，输入普通只读账户的帐号密码

### 拓展
---
信工三年的学业任务当数一年级最轻松，除主修学业之外，建议大家拓展知识面和参加社交活动，推荐值得做的两件事：辅修和社团。
#### 辅修
...
对于技术型部门，个人觉得学院内无协的三个技术部门、微软俱乐部、百步梯技术部都挺好，当然口碑越好竞争越激烈。

#### 开网
网络资源对电信学子来说是非常重要的，但南校电信学院在大一被禁止使用网络，阻碍大家汲取知识的脚步。而华工校园网采用双栈接入，ipv4地址受学校管制，ipv6无状态自动获取公网ip，不限流不限速不断网，故稍加指导利用ipv6网络，等到大二能缴费使用v4网络请自觉缴费。详情见文章：[华工电信维溜](https://github.com/Sampson-Lee/SCUT_EE_IPv6/blob/master/华工电信维溜.md)
