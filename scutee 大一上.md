...
---
#### 课程
C/C++是一种广泛使用的计算机程序设计语言，课程内容主要是掌握语法知识及其计算机应用，目前最值得掌握的两门语言是C/C++和python。对于编程，如果课后不花大量时间拓展学习，就不能算掌握。为真正理解C++，入门书籍推荐《C++ Primer plus》，进阶书籍推荐《Effective C++》，更多书籍详见文章 [C++必读书籍推荐](http://bestcbooks.com/recommended-cpp-books/)。当然，实战也不能落后，推荐编译器Dev C++以及前往 [PAT乙级](https://www.patest.cn/contests/pat-b-practise) 刷题，推荐每个人花时间参加ACM学习【from刘巍】。编程是一条很长的路，需要踏踏实实往前走，坚持下来就会发现收获很多。
...
> 英语主要靠平时积累，推荐几款移动端软件：“百词斩”、“知米听力”、“扇贝阅读”、“欧路词典”，PC端配合移动端使用“欧陆词典”查询单词。在下平时练习英语的时间不多，能够较多接触英文的时间是在PC端阅读文献（英文）以及观看国外教程视频，建议配备划词翻译软件，大胆接触英文环境。
